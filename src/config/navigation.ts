...
export const navItems: NavItem[] = [
    ...
    { label: 'Documents', path: '/documents', icon: FileText, roles: ['ADMIN', 'DIRECTOR', 'MEMBER'], section: 'Recherche' },
    { label: 'Équipements', path: '/equipment', icon: Package, roles: ['ADMIN', 'DIRECTOR', 'MEMBER'], section: 'Ressources' },
    { label: 'Notifications', path: '/notifications', icon: Bell, section: 'Ressources' },
    { label: 'Messagerie', path: '/messaging', icon: MessageSquare, roles: ['MEMBER', 'DIRECTOR', 'ADMIN'], section: 'Ressources' },
